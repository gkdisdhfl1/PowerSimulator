#ifndef FUNDAMENTAL_ANALYSIS_GRAPH_WINDOW_H
#define FUNDAMENTAL_ANALYSIS_GRAPH_WINDOW_H
...
class FundamentalAnalysisGraphWindow : public BaseGraphWindow
{
    Q_OBJECT
public:
    explicit FundamentalAnalysisGraphWindow(SimulationEngine *engine, QWidget *parent = nullptr);
...
#endif // FUNDAMENTAL_ANALYSIS_GRAPH_WINDOW_H
